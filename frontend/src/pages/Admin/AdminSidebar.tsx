...
import {FaCalendarAlt,FaUserInjured,FaUserMd,FaHospital,FaBars,FaTimes,FaSignOutAlt,} from "react-icons/fa";
    ...
    <div className="flex h-full flex-col">
      <div>
        <div className="mb-6 rounded-3xl bg-white p-5 shadow-md">
          ...
          <p className="mt-1 text-sm font-medium text-slate-500">Manage hospital system</p>
        </div>
