...
export const MyProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const patient =
        res.data?.data?.patient || res.data?.patient || res.data?.data || res.data;
  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-8 pt-24 sm:px-6 lg:px-8 lg:pt-28">
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {!isEdit ? (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-blue-600 px-5 py-3 font-semibold text-blue-600 transition hover:bg-blue-600 hover:text-white sm:w-auto"
              >
                <FaEdit />
                Edit Profile
              </button>
              ...
              <div className="grid grid-cols-2 gap-3 sm:flex">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-lg bg-gray-200 px-5 py-3 font-semibold text-gray-700 transition hover:bg-gray-300"
                >
                  <FaTimes />
                  Cancel
                </button>
              ...
              <div className="relative h-36 w-36 sm:h-40 sm:w-40">
                {imageUrl ? (
                  <img
                    src={imageUrl}
                    alt="Patient"
                    className="h-36 w-36 rounded-full object-cover object-top shadow-lg sm:h-40 sm:w-40"
                  />
                ) : (
    ...
    <div className="relative flex gap-4 border-b border-gray-200 pb-4">
      <span
        className={`mt-1 shrink-0 ${
          label === "Blood Group" ? "text-red-600" : "text-blue-500"
        }`}
      >
        {icon}
      </span>
