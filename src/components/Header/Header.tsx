...
//------Function for slider images changes every 3.5 seconds---------
  ...
  return (
    <section className="w-full mt-10 overflow-hidden shadow-xl">
      <div className="relative h-[340px] xs:h-[370px] sm:h-[420px] md:h-[450px] lg:h-[470px] xl:h-[490px]">
        ...
        <div  className="relative z-10 flex h-full items-center px-4 py-4 sm:px-6 md:px-10 lg:px-14 xl:px-16">
          <div className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
            <div  className="mb-2 inline-flex rounded-full bg-blue-900/90 px-3 py-1 text-[10px] font-semibold text-white sm:px-3 sm:py-1.5 sm:text-[11px]">
              Trusted Healthcare Platform
            </div>
            <h1 className="text-xl font-extrabold leading-tight text-white xs:text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px]">
              Quality{" "}
            ...
            <p className="mt-1.5 max-w-sm text-[11px] leading-5 text-white/85 xs:text-xs xs:leading-6 sm:max-w-md sm:text-sm sm:leading-6">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3 sm:mt-6">
              <Link to="/doctors"  className="flex items-center gap-2 rounded-full bg-red-700 px-4 py-2 text-xs font-semibold text-white shadow-lg transition duration-300 hover:scale-105 xs:gap-3 xs:px-6 xs:py-3 xs:text-sm sm:px-5 sm:py-2.5 sm:text-sm">
                Book Appointment
                <FaArrowRight />
              </Link>
            </div>
...
//------Current animated dots----------
  ...
  return (
    <div className="rounded-xl bg-white/10 p-1.5 text-center shadow-lg backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:bg-white/15 xs:rounded-2xl xs:p-2 sm:p-2.5">
      <h3  className={`text-sm font-extrabold xs:text-base sm:text-lg md:text-xl ${color}`}>
        {count}{suffix}
      </h3>
      <p className="mt-0.5 text-[8px] font-semibold text-white xs:text-[9px] sm:text-[10px]">
        {label}
      </p>
    </div>
  );
