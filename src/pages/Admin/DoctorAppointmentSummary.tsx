...
function StatBadge({ value, label, colorClass, bgClass }: {
  ...
  return (
    <div className={`flex flex-col items-center rounded-xl px-3 sm:px-4 py-2 ${bgClass}`}>
      <span className={`text-base sm:text-lg font-extrabold leading-tight ${colorClass}`}>{value}</span>
