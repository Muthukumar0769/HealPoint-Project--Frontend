...
import DoctorHero from "../../assets/images/AboutImg.jpg";
...
export const About = () => {
  ...
  return (
    <main className="min-h-screen pt-24 bg-[#f0f4fb] text-gray-800 sm:pt-15">
      <section className="relative w-full overflow-hidden bg-cover bg-center bg-no-repeat"
        ...
        <div className="relative z-10 flex min-h-[520px] items-center px-5 py-14 sm:min-h-[600px] sm:px-8 lg:min-h-[530px] lg:px-10">
